#!/bin/bash
# ================================================================================
# INSTALADOR DE DOCKER EN DEBIAN 12 (BOOKWORM)
# ================================================================================
# Autor: Carlos Silva
...
if ! grep -q "bookworm" /etc/os-release 2>/dev/null; then
    echo -e "${RED}[✗] Este script solo funciona en Debian 12 (Bookworm)${NC}"
    exit 1
fi
...
echo ""
echo "================================================================================"
echo -e "${BLUE}  INSTALADOR DE DOCKER EN DEBIAN 12 (BOOKWORM)${NC}"
echo "================================================================================"
echo ""
